        ...
        <div className="w-full sm:w-[40pc] relative z-10 p-6 bg-darkBlue-500 rounded-xl">
          <p className="flex flex-col gap-2">
            ...
            <p className="text-white/60">
              Welcome to U²Marketplace, your premier Ethereum NFT Marketplace. This
              ...
              <br />
              <br />
              By using U²Marketplace, you agree to the terms outlined in this
            ...
            <p className="text-white/60 flex flex-col gap-1 ml-5">
              ...
              <ol className="list-disc ml-4">
                <li>
                  When you create an account on U²Marketplace, we collect your
            ...
            <p className="text-white/60 flex flex-col gap-1 ml-5">
              ...
              <ol className="list-disc ml-4">
                <li>
                  U²Marketplace operates on the Ethereum blockchain using ERC721
            ...
            <p className="text-white/60 flex flex-col gap-1 ml-5">
              ...
              <ol className="list-disc ml-4">
                <li>
                  ...
                  sales on the U²Marketplace platform.
                </li>
              </ol>
            </p>
            <p className="text-white/60 flex flex-col gap-1 ml-5">
            ...
            <p className="text-white/60 flex flex-col gap-1 ml-5">
              <ol className="list-disc ml-4">
                <li>
                  U²Marketplace implements security measures to protect your
